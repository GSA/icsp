...
<ul class="usa-list">
  <li>On August 18, 2023, OMB published a Notice of Proposed Rulemaking on the Fundamental Responsibilities of Statistical Agencies and Units, or the “Trust Regulation.” This marks a key milestone in the implementation of the Foundations for Evidence-Based Policymaking Act of 2018 (Evidence Act). For more information, read the <a href="{{site.baseurl}}/assets/files/TrustRegNewsUpdate.pdf">announcement</a> from the Chief Statistician of the United States.</li>
